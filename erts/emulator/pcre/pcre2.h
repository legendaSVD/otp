...
#define PCRE2_ALT_EXTENDED_CLASS  0x08000000u
...
#define PCRE2_EXTRA_PYTHON_OCTAL             0x00002000u
#define PCRE2_EXTRA_NO_BS0                   0x00004000u
#define PCRE2_EXTRA_NEVER_CALLOUT            0x00008000u
#define PCRE2_EXTRA_TURKISH_CASING           0x00010000u
#define PCRE2_EXTRA_LOOP_LIMIT               0x00020000u
...
#define PCRE2_DISABLE_RECURSELOOP_CHECK   0x00040000u
...
PCRE2_EXP_DECL void PCRE2_CALL_CONVENTION \
  pcre2_set_loops_left(pcre2_match_data *, int); \
PCRE2_EXP_DECL int PCRE2_CALL_CONVENTION \
 pcre2_get_loops_left(pcre2_match_data *);	       \
PCRE2_EXP_DECL int PCRE2_CALL_CONVENTION	       \
  pcre2_set_restart_data(pcre2_match_data *, void **); \
PCRE2_EXP_DECL int PCRE2_CALL_CONVENTION \
  pcre2_set_restart_flags(pcre2_match_data *, uint32_t); \
PCRE2_EXP_DECL int PCRE2_CALL_CONVENTION \
...
#define pcre2_free_restart_data               PCRE2_SUFFIX(pcre2_free_restart_data_)
...
#define pcre2_get_loops_left                  PCRE2_SUFFIX(pcre2_get_loops_left_)
#define pcre2_set_loops_left                  PCRE2_SUFFIX(pcre2_set_loops_left_)
...
#define pcre2_set_restart_data                PCRE2_SUFFIX(pcre2_set_restart_data_)
#define pcre2_set_restart_flags               PCRE2_SUFFIX(pcre2_set_restart_flags_)
