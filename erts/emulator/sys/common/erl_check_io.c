...
typedef enum {
    ERTS_EV_TYPE_NONE     = 0,
    ERTS_EV_TYPE_DRV_SEL  = 1,
    ERTS_EV_TYPE_STOP_USE = 2,
    ERTS_EV_TYPE_NIF      = 3,
    ERTS_EV_TYPE_STOP_NIF = 4
} EventStateType;
typedef enum {
    ERTS_EV_FLAG_CLEAR         = 0x0,
    ERTS_EV_FLAG_USED          = 0x1,
#if ERTS_POLL_USE_SCHEDULER_POLLING
    ERTS_EV_FLAG_SCHEDULER     = 0x2,
    ERTS_EV_FLAG_IN_SCHEDULER  = 0x4,
    ERTS_EV_FLAG_NIF_SELECT    = 0x8,
#else
    ...
    ERTS_EV_FLAG_FALLBACK      = 0x10,
#else
    ERTS_EV_FLAG_FALLBACK      = ERTS_EV_FLAG_CLEAR,
#endif
    ERTS_EV_FLAG_WANT_ERROR    = 0x20,
                               ...
                               Eterm event_atom)
{
    ...
    Eterm* hp, *hp_start;
    Uint hsz = sizeof(ErtsNifSelectSignalData) / sizeof(Eterm);
