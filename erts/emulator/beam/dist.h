...
#define DFLAG_ETS_COMPRESSED         ((Uint64)0x8000)
...
#define DFLAG_PENDING_CONNECT      ((Uint64)0x200000)
...
#define DFLAG_LOCAL_EXT        (((Uint64)0x10) << 32)
...
#endif
#define ERTS_DIST_FRAGMENT_HEADER_SIZE (1 + 1 + 8 + 8)
