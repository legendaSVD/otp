...
void BeamGlobalAssembler::emit_i_line_breakpoint_trampoline_shared() {
    ...
    a.mov(ARG1, c_p);
    a.mov(ARG2, saved_pc);
    a.mov(ARG3, saved_live);
    load_x_reg_array(ARG4);
    a.lea(ARG5, getYRef(0));
    emit_enter_runtime();
    runtime_call<
