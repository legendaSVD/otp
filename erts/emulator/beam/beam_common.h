...
extern ErtsCodePtr beam_return_to_trace;
extern ErtsCodePtr beam_return_trace;
extern ErtsCodePtr beam_exception_trace;
extern ErtsCodePtr beam_call_trace_return;
ERTS_GLB_INLINE
