...
ErtsMonotonicTime erts_halt_flush_timeout = -1;
...
Uint H_MAX_SIZE;
int H_MAX_FLAGS;
Uint32 erts_debug_flags;
int erts_backtrace_depth;
erts_atomic32_t erts_max_gen_gcs;
Eterm erts_error_logger_warnings;
int erts_compat_rel;
...
int erts_pd_initial_size = 8;
int erts_modified_timing_level;
int erts_no_crash_dump = 0;
int erts_no_line_info = 0;
#ifdef BEAMASM
Uint erts_coverage_mode = ERTS_COV_NONE;
int erts_jit_asm_dump = 0;
#endif
ErtsModifiedTimings erts_modified_timings[] = {
    	{make_small(0), CONTEXT_REDS},
    	{make_small(0), (3*CONTEXT_REDS)/4},
    	{make_small(0), CONTEXT_REDS/2},
    	{make_small(0), (7*CONTEXT_REDS)/8},
    	{make_small(0), CONTEXT_REDS/3},
    	{make_small(0), (10*CONTEXT_REDS)/11},
    	{make_small(1), CONTEXT_REDS/4},
    	{make_small(1), (5*CONTEXT_REDS)/7},
    	{make_small(10), CONTEXT_REDS/5},
    	{make_small(10), (6*CONTEXT_REDS)/7}
};
...
early_init(int *argc, char **argv)
{
    ...
    erts_alloc_init(argc, argv, &alloc_opts);
