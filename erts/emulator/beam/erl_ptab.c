...
struct ErtsPTabListBifData_ {
    ...
    int pid_sz;
    Eterm *pid;
    ErtsPTabDeletedElement *bif_invocation;
		     ...
		     int atomic_refc)
{
    ...
    ASSERT((ptab->r.o.max & (ptab->r.o.max - 1)) == 0);
    ASSERT((ix_per_cache_line & (ix_per_cache_line - 1)) == 0);
    ASSERT((tab_cache_lines & (tab_cache_lines - 1)) == 0);
