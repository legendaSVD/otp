...
#define ERTS_SCHED_THREAD_MIN_STACK_SIZE 20
#define ERTS_SCHED_THREAD_MAX_STACK_SIZE 8192
#include "erl_bits.h"
...
typedef enum {
    ...
    ERTS_SSI_AUX_WORK_DEBUG_WAIT_COMPLETED_IX,
    ERTS_SSI_AUX_WORK_NO_FLAGS
...
#define ERTS_PSD_PENDING_SUSPEND                13
...
struct process {
    ...
    ErtsCodePtr i;
    Sint catches;
    Sint return_trace_frames;
    Uint reds;
    Eterm group_leader;
    Eterm ftrace;
    Process *next;
    Sint64 uniq;
    ErtsSignalPrivQueues sig_qs;
    ...
    Eterm *old_heap;
    ErlOffHeap off_heap;
    struct erl_off_heap_header* wrt_bins;
    ...
    Eterm* last_htop;
    ErlHeapFragment* last_mbuf;
    ErlHeapFragment* heap_hfrag;
#endif
#ifdef DEBUG
    Eterm* last_old_htop;
#endif
    ...
    Uint space_verified;
    Eterm* space_verified_from;
#endif
#ifdef DEBUG
    Uint debug_reds_in;
#endif
};
extern Eterm erts_init_process_id;
...
#define F_HIBERNATE_SCHED    (1 <<  0)
#define F_INSLPQUEUE         (1 <<  1)
#define F_TIMO               (1 <<  2)
#define F_HEAP_GROW          (1 <<  3)
#define F_NEED_FULLSWEEP     (1 <<  4)
#define F_USING_DB           (1 <<  5)
#define F_DISTRIBUTION       (1 <<  6)
#define F_USING_DDLL         (1 <<  7)
#define F_HAVE_BLCKD_MSCHED  (1 <<  8)
#define F_ETS_SUPER_USER     (1 <<  9)
#define F_FORCE_GC           (1 << 10)
#define F_DISABLE_GC         (1 << 11)
#define F_ABANDONED_HEAP_USE (1 << 12)
#define F_DELAY_GC           (1 << 13)
#define F_SCHDLR_ONLN_WAITQ  (1 << 14)
#define F_HAVE_BLCKD_NMSCHED (1 << 15)
#define F_DELAYED_DEL_PROC   (1 << 16)
#define F_DIRTY_CLA          (1 << 17)
#define F_DIRTY_GC_HIBERNATE (1 << 18)
#define F_DIRTY_MAJOR_GC     (1 << 19)
#define F_DIRTY_MINOR_GC     (1 << 20)
#define F_HIBERNATED         (1 << 21)
#define F_TRAP_EXIT          (1 << 22)
#define F_FRAGMENTED_SEND    (1 << 23)
#define F_DBG_FORCED_TRAP    (1 << 24)
#define F_DIRTY_CHECK_CLA    (1 << 25)
#define F_ASYNC_DIST         (1 << 26)
#define FS_OFF_HEAP_MSGQ       (1 << 0)
#define FS_ON_HEAP_MSGQ        (1 << 1)
#define FS_OFF_HEAP_MSGQ_CHNG  (1 << 2)
#define FS_UNUSED              (1 << 3)
#define FS_HANDLING_SIGS       (1 << 4)
#define FS_WAIT_HANDLE_SIGS    (1 << 5)
#define FS_UNUSED2             (1 << 6)
#define FS_FLUSHING_SIGS       (1 << 7)
#define FS_FLUSHED_SIGS        (1 << 8)
#define FS_NON_FETCH_CNT1      (1 << 9)
#define FS_NON_FETCH_CNT2      (1 << 10)
#define FS_NON_FETCH_CNT4      (1 << 11)
#define FS_MON_MSGQ_LEN_HIGH   (1 << 12)
#define FS_MON_MSGQ_LEN_LOW    (1 << 13)
#define FS_SET_SAVE_INFO_1     (1 << 14)
#define FS_SET_SAVE_INFO_2     (1 << 15)
#define FS_PRIO_MQ_SAVE        (1 << 16)
#define FS_PRIO_MQ             (1 << 17)
#define FS_PRIO_MQ_END_MARK    (1 << 18)
#define FS_DBG_MQ_PTRS_UNREL   (1 << 31)
...
#define F_TRACE_SOS          F_TRACE_FLAG(3)
#define F_TRACE_SOS1         F_TRACE_FLAG(4)
#define F_TRACE_SOL          F_TRACE_FLAG(5)
#define F_TRACE_SOL1         F_TRACE_FLAG(6)
...
#define F_TRACE_RETURN_TO    F_TRACE_FLAG(13)
#define F_TRACE_SILENT       F_TRACE_FLAG(14)
#define F_TRACE_DBG_CANARY   F_TRACE_FLAG(15)
#define F_TRACE_SCHED_PORTS  F_TRACE_FLAG(17)
#define F_TRACE_SCHED_PROCS  F_TRACE_FLAG(18)
#define F_TRACE_PORTS	     F_TRACE_FLAG(19)
#define F_TRACE_SCHED_NO     F_TRACE_FLAG(20)
#define F_TRACE_SCHED_EXIT   F_TRACE_FLAG(21)
#define F_TRACE_RETURN_TO_MARK  F_TRACE_FLAG(22)
