...
ZSTDLIB_STATIC_API size_t ZSTD_decompressStream_simpleArgs (
                            ...
                            void* dst, size_t dstCapacity, size_t* dstPos,
                      const void* src, size_t srcSize, size_t* srcPos);
ZSTD_DEPRECATED("use ZSTD_CCtx_reset, see erl_zstd.h for detailed instructions")
ZSTDLIB_STATIC_API
...
size_t ZSTD_initCStream_advanced(ZSTD_CStream* zcs,
                    const void* dict, size_t dictSize,
                          ZSTD_parameters params,
                          unsigned long long pledgedSrcSize);
ZSTD_DEPRECATED("use ZSTD_CCtx_reset and ZSTD_CCtx_refCDict, see erl_zstd.h for detailed instructions")
ZSTDLIB_STATIC_API
...
ZSTD_DEPRECATED("use ZSTD_DCtx_reset + ZSTD_DCtx_loadDictionary, see erl_zstd.h for detailed instructions")
ZSTDLIB_STATIC_API size_t ZSTD_initDStream_usingDict(ZSTD_DStream* zds, const void* dict, size_t dictSize);
ZSTD_DEPRECATED("use ZSTD_DCtx_reset + ZSTD_DCtx_refDDict, see erl_zstd.h for detailed instructions")
ZSTDLIB_STATIC_API size_t ZSTD_initDStream_usingDDict(ZSTD_DStream* zds, const ZSTD_DDict* ddict);
ZSTD_DEPRECATED("use ZSTD_DCtx_reset, see erl_zstd.h for detailed instructions")
